...
export default function UsersPage() {
  ...
  const filteredUsers = users.filter((user) => {
    // Apply search filter — tolerate users missing any of name/email/username
    // (older accounts may pre-date one of these fields).
    if (searchTerm) {
      ...
      <div className="mt-6 flex flex-col sm:flex-row gap-4">
        <div className="flex-1">
          <input
            ...
            className="block h-10 w-full rounded-md border-gray-300 px-3 py-2 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
          />
        </div>
